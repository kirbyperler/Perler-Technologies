...
// General project lifecycle -- admin-managed, independent of questionnaire progress.
const PROJECT_STATUSES = ['Active', 'On Hold', 'Completed', 'Cancelled'];

// Separate "discovery" status, auto-updated as a project's questionnaire(s) progress
// (see api/questionnaires.js). Kept apart from PROJECT_STATUSES so a questionnaire
// being sent/completed never silently overwrites the project's own status field.
const DISCOVERY_STATUSES = ['Not Started', 'Sent', 'Viewed', 'In Progress', 'Complete'];
